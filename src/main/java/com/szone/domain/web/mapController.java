...
public class mapController { 
	...
	public String intro(HttpServletRequest req, HttpServletResponse res) {
		return "redirect:/crossTrafficInfoPage.do";
	}
	...
	//링크속도, 링크교통량, 음영구간 메뉴에서 차로별 음영유형 함수 실행
	@Scheduled(cron = "0 0 * * * *")
	@RequestMapping("/getSzoneRoad.do")
	public void getSzoneRoad(HttpServletRequest req, HttpServletResponse res, @RequestBody TrafficInfo traffic) {
		smtlService.insertSzoneRoad(traffic);
	}
	...
	//교차로교통량 노드생성 함수 실행
	@Scheduled(cron = "0 0 * * * *")
	@RequestMapping("/getCrossNodeInfo.do")
	public void getCrossNodeInfo(HttpServletRequest req, HttpServletResponse res, @RequestBody TrafficInfo traffic) {
		smtlService.insertCrossNode(traffic);
	}
	
	@Scheduled(cron = "0 0 * * * *")
	@RequestMapping("/insertWaitingLine.do")
	public void insertWaitingLine(HttpServletRequest req, HttpServletResponse res, @RequestBody TrafficInfo traffic) {
		smtlService.insertWaitingLine(traffic);
	}
	...
	public ResponseEntity<Map<String, List<Device>>> getDeviceInfo(HttpServletRequest req, HttpServletResponse res, @RequestBody Device device) {
